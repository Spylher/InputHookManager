...
public unsafe partial struct Context
{
    ...
    public KeyboardDriver* Keyboards => (KeyboardDriver*)Devices;
    public KeyboardDriver* FirstKeyboard => Keyboards;
    public KeyboardDriver* LastKeyboard => Keyboards + MaxKeyboards - 1;

    public MouseDriver* Mouses => (MouseDriver*)(Devices + MaxMouses);
    public MouseDriver* FirstMouse => Mouses;
    public MouseDriver* LastMouse => Mouses + MaxMouses - 1;

    public int GetIndexOfDevice(Device* device) => (int)(Devices - device);

    public MouseDriver* WaitMouseInput() => (MouseDriver*)WaitDeviceInput((Device*)FirstMouse, (Device*)LastMouse, INFINITE);

    public KeyboardDriver* WaitKeyboardInput() => (KeyboardDriver*)WaitDeviceInput((Device*)FirstKeyboard, (Device*)LastKeyboard, INFINITE);
